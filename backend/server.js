...
app.post('/api/peliculas', async (req, res) => {
    try {
        const { titulo, director, sinopsis, imagen_url, anio, id_genero, id_seriepeli } = req.body;
        ...
        const resultado = await pool.query(
            'INSERT INTO contenido.tpeliculas (titulo, director, sinopsis, imagen_url, anio, id_genero, id_seriepeli) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *',
            [titulo, director, sinopsis, imagen_url, anio, id_genero, id_seriepeli]
        );
...
app.put('/api/peliculas/:id', async (req, res) => {
    try {
        ...
        const resultado = await pool.query(
            'UPDATE contenido.tpeliculas SET titulo = $1, director = $2, sinopsis = $3, imagen_url = $4, anio = $5, id_genero = $6, id_seriepeli = $7 WHERE id_pelicula = $8 RETURNING *',
            [titulo, director, sinopsis, imagen_url, anio, id_genero, id_seriepeli, id]
        );
